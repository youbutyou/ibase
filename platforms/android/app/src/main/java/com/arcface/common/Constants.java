package com.arcface.common;

public class Constants {

    public static final String APP_ID = "8hJB2aN6LCPyhvGFFYE5hY9KQBXP46yFDMtY8fuDFaB4";
    public static final String SDK_KEY = "BsGENEbZuKRXnTRxRjxRMZwi2meedxMNFVRnyrwTf5uS";
